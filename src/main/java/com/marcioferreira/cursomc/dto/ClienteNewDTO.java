...
import com.marcioferreira.cursomc.services.validation.ClienteInsert;

/* classe para incluir cliente e as relações */
/* @ClienteInsert - anotação criada para validar CPF ou CNPJ - ver service.validation */
@ClienteInsert
